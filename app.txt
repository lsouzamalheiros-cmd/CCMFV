...
st.set_page_config(page_title="Sistema Escolar - CCMCEMR by Leandro Malheiros V2.0.3 ", layout="centered")
...
@st.cache_resource
def conectar():
    uri = "mongodb+srv://lsouzamalheiros_db_user:malheiros76@cluster0.10ycbss.mongodb.net/"
...
👨‍🏫 Escola [CCM Manuel Ribas]
📞 Contato: [42 3623-4640]
...
def exportar_ocorrencias_para_pdf(ocorrencias, nome_arquivo):
    ...
    elementos.append(Paragraph(
        "<b>COLÉGIO CÍVICO MILITAR MANUEL RIBAS</b>",
        cabecalho_style
    ))
