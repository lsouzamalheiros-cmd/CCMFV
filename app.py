...
st.set_page_config(page_title="Sistema Escolar - CCMFV by Leandro Malheiros V2.0.3 ", layout="centered")
...
@st.cache_resource
def conectar():
    uri = "mongodb+srv://lsouzamalheiros_db_user:malheiros76@cluster0.uwsboas.mongodb.net/"
...
👨‍🏫 Escola [CCM Francisco Villanueva]
📞 Contato: [43 3256-1825]
...
def exportar_ocorrencias_para_pdf(ocorrencias, nome_arquivo):
    ...
    elementos.append(Paragraph(
        "<b>COLÉGIO CÍVICO MILITAR FRANCISCO VILLANUEVA</b>",
        cabecalho_style
    ))
